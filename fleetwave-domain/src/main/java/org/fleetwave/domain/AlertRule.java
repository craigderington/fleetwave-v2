...
public class AlertRule {
  ...
  private boolean enabled = true; private int cooldownSec = 900;
  ...
  public Severity getSeverity(){return severity;} public void setSeverity(Severity s){this.severity=s;}
  public boolean isEnabled(){return enabled;} public void setEnabled(boolean e){this.enabled=e;}
  public int getCooldownSec(){return cooldownSec;} public void setCooldownSec(int c){this.cooldownSec=c;}
  public String getConfigJson(){return configJson;} public void setConfigJson(String c){this.configJson=c;}
