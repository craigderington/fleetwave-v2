...
public class RadioController{ private final RadioRepository radios; public RadioController(RadioRepository r){radios=r;}

  @GetMapping
  public List<Radio> list(){ return radios.findAll(); }
